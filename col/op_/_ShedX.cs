...
namespace nilnul.num.real.matrix.col.op_
{
	...
	static public class _ShedX
	{
		...
		static public void _Shed(ref double[,] m, int col, double divisor)
		{
		...
		static public void _Shed(ref Q[,] m, int col, Q divisor)
		{
		...
		static public void _Shed(ref Q[,] m, long col, Q divisor)
		{
			int high = m.GetLength(0);
		...
		static public void _Shed(ref double[,] m, long col, double divisor)
		{
			int high = m.GetLength(0);
