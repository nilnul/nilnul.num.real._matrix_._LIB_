...
{
	/// <see cref="real.matrix.op_.indent_.echelon_.regula_"/>, with zero rows appended.
	/// 
	/// <summary>
	/// convert to canonical, while keep the same hull.
	/// </summary>
	/// <remarks>
	/// eg:
	///		[
	...
	/// </remarks>
	/// 
	/// <see cref="real.matrix.op_.indent_.echelon_.dedund_._RegulateX"/>
	/// alias:
