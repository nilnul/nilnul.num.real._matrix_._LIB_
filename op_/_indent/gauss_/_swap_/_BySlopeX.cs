...
namespace nilnul.num.real.matrix.op_.rowspan_._swap_
{
	...
	static public class _BySlopeX
	{
		...
		static public void _Shuffle_assumeValid(
			...
			///
			nilnul.num.real.matrix.op_.unary_.elementary_.rowwise_._ScaleX._Scale_rowAssumeIn_ratioAssumeNonnil(in m, in b,  -1);
			//:  a+b, a
		...
		static public void _Shuffle_assumeValid(
			...
			nilnul.num.real.matrix.op_.unary_.elementary_.rowwise_._ScaleX._Scale_rowAssumeIn_ratioAssumeNonnil(in m, in r1,  -1);
