...
namespace nilnul.num.real.matrix_.sq.cel._minor_.by_
{
	...
	public static  class _ByGenerateNewX
	{

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		static public double _AssumeValid(double[,] matrix,int i,int j) {

			return num.real.matrix_.sq._DeterminantX._Determinant_0sq(nilnul.obj.matrix.cel._RemnantX._Remnant_celAssumeValid(matrix, i, j));
