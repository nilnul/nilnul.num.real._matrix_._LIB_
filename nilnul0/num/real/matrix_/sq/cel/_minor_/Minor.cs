...
namespace nilnul.num.real.matrix_.sq.aggregate_
{
	/// <summary>
	...
	public static    class _MinorX
	{
		static public double Eval(double[,] matrix,int i,int j) {
			...
			return real.matrix_.sq._DeterminantX._Determinant_0square(nilnul.collection.matrix.MatrixX.Delete(matrix, i, j));
		...
		static public R3 Minor(matrix_.Square1 square, int i, int j) {
