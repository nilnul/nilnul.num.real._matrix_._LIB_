...
{
	[Obsolete(nameof(sq.to_.scalar_._DeterminantX))]
	public class Determinant
	{
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static double Eval(params double[] squareMatrix) {

			return nilnul.num.real.matrix_.Square4dbl.OfEls(squareMatrix).ee.Determinant();
		...
		public static double _Eval_2x2(double[] v0, double[] v1) {
			...
			return new nilnul.num.real.matrix_.sq_.Secondary4dbl(v0[0], v0[1], v1[0], v1[1]).ee.Determinant();
		...
		public static R3 Eval_2x2(R3 x,R3 x1, R3 y, R3 y1) {
